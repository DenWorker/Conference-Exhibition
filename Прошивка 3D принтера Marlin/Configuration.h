...
#define STRING_CONFIG_H_AUTHOR "Denis Ivanov" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Denis printer"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 95.785 }
